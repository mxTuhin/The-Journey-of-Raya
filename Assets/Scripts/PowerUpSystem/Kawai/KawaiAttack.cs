...
public class KawaiAttack : PowerUpBase
{
    ...
    private IEnumerator SpawnKawaiSlimeRoutine(Transform target)
    {
        ...
        ParticleSystem particleSystem = ObjectPool.GetInstance().GetObject(kawaiSpawnParticle.gameObject).GetComponent<ParticleSystem>();
